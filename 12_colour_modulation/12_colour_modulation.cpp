...
bool loadMedia()
{
    ...
    // load spritesheet
    if (gSampleColour.loadFromFile("colour_samples.png", gRenderer) == false)
    {
        printf("Failed to load colour sample texture. \n");
    ...
    else
    {
        ...
        else
        {
            ...
            while (!quit)
            {
                ...
                // draw
                gSampleColour.setColour(red, green, blue);
                gSampleColour.render(0, 0, gRenderer);
